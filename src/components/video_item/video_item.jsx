...
const Videoitem = memo(
    ({video , onVideoClicktoitem , display}) => {
        const displayType = display === 'list' ? styles.list : styles.grid;
        return (
        <li className={`${styles.container} ${displayType}`} onClick = {() => {console.log('onvideoclicktoitem');onVideoClicktoitem(video); console.log('onvideoclicktoitemback')}}>
            {onVideoClicktoitem && console.log('item!!')}
